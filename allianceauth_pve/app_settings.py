...
PVE_ONLY_MAINS: bool = getattr(settings, "PVE_ONLY_MAINS", False)
...
ROTATION_PROJECT_SUMMARY_CACHE_KEY = (
    "allianceauth_pve_rotation_project_summaries_{rotation_id}"
)
ROTATION_PROJECT_SUMMARY_CACHE_TIMEOUT = ROTATION_SUMMARY_CACHE_TIMEOUT

FUNDING_PROJECT_SUMMARY_CACHE_KEY = (
    "allianceauth_pve_funding_project_summary_{project_id}"
)
FUNDING_PROJECT_SUMMARY_CACHE_TIMEOUT = ROTATION_SUMMARY_CACHE_TIMEOUT

PVE_IGNORED_ITEM_GROUPS: set[int] = set(
    getattr(settings, "PVE_IGNORED_ITEM_GROUPS", [])
)
PVE_IGNORED_ITEM_IDS: set[int] = set(getattr(settings, "PVE_IGNORED_ITEM_IDS", []))
