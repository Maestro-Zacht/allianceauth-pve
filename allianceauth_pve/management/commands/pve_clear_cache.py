...
from allianceauth_pve.models import Rotation, FundingProject, EntryCharacter
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        cache.delete_many(
            ...
            for user_id in EntryCharacter.objects.values_list('user_id', flat=True).distinct()
